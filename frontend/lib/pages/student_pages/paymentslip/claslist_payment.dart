...
import 'package:frontend/pages/student_pages/paymentslip/take_payment.dart';
...
class ClassListPaymentSlip extends StatefulWidget {
  const ClassListPaymentSlip({super.key});

  @override
  State<ClassListPaymentSlip> createState() => _ClassListPaymentSlipState();
}

class _ClassListPaymentSlipState extends State<ClassListPaymentSlip> {
  String firstName = "";
  String lastName = "";
  String email = "";
  String role = "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Class List Payment")),
      body: Padding(
