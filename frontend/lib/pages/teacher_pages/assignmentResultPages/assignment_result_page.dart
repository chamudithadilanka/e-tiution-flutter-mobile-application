...
import 'package:frontend/pages/teacher_pages/assignmentResultPages/assingment_submission_single_page.dart';
import 'package:frontend/utils/colors.dart';
import 'package:shared_preferences/shared_preferences.dart';

class AssingmentResulPages extends StatefulWidget {
  const AssingmentResulPages({super.key});

  @override
  State<AssingmentResulPages> createState() => _AssingmentResulPagesState();
}

class _AssingmentResulPagesState extends State<AssingmentResulPages> {
                                              ...
                                              onPressed: () {
                                                Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder:
                                                        (context) =>
                                                            AssingmentSubmissionSinglePage(
                                                              ClassId:
                                                                  classModel.id,
                                                            ),
                                                  ),
