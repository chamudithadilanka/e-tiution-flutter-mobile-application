...
class ClassListTimeSchedule extends StatefulWidget {
  const ClassListTimeSchedule({super.key});

  @override
  State<ClassListTimeSchedule> createState() => _ClassListTimeScheduleState();
}

class _ClassListTimeScheduleState extends State<ClassListTimeSchedule> {
  String firstName = "";
  String lastName = "";
  String email = "";
  String role = "";
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          "Check Your TimeSchedule for Class",
                                          style: TextStyle(
                                            fontSize: 18,
