...
class TeacherFontOnBoard extends StatefulWidget {
  final String uname;
  final String stuId;
  const TeacherFontOnBoard({
    super.key,
    required this.uname,
    required this.stuId,
  });
  ...
  @override
  State<TeacherFontOnBoard> createState() => _TeacherFontOnBoardState();
}

class _TeacherFontOnBoardState extends State<TeacherFontOnBoard> {
  @override
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        kMainColor,
                        const Color.fromARGB(255, 75, 125, 250),
                      ],
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 50),
                        Lottie.asset(
                          "assets/animations/Animation - 1746586961495.json",
                          fit: BoxFit.cover,
                          // width: 280,
                          // height: 280,
                        ),
